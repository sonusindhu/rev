    ...
    <div class="modal-content notice_dv">
        ...
        <div class="modal-body clearfix">
            <div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
                ...
                <form id="addLenderTipsForm" ng-submit="addLenderTips('<?php echo $this->webroot; ?>company/lenders/addtips?lender_id=<?php echo $lenderid; ?>')">
                    ...
                    <input type="hidden" value="<?php echo $lenderid; ?>" name="data[LenderTip][lender_id]">
                                ...
                                <div class="col-md-12  tip_textarea spc ">
                                    ...
                                    <div class="form-group send_msg">
                                        <div id="datetimepicker4" class="input-group date res_mar">
                                            <input type="text" class="form-control datepicker" name="data[LenderTip][delete_on]">
                                    ...
                                    <label>Tip</label>
                                    <textarea rows="" cols="" ck_editor name="data[LenderTip][message]" ng-model="a.b" ng-bind-html="showPreview"></textarea>
