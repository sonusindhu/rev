...
<!--                        <li class="dropdown">
                                ...
                                <li>
                                    <a href="#">
                                        <span>
                                            ...
                                            <img src="{!! asset('images/profile_img.png') !!}" alt=""/>
                                        </span>
                                        <span class="online"></span><p><span>Andy Sent you Message</span></p>
                                        <span class="time_fnt">15 Minutes Ago</span>

                                    </a></li>
                                <li><a href="#"><span><img src="{!! asset('images/profile_img.png') !!}" alt=""/></span>
                        ...
                        <li class="dropdown act_cls">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <?php if (isset(Auth::User()->id) && !empty(Auth::User()->emp_image)) { ?> <img src="upload/Employee/<?php echo Auth::User()->emp_image; ?>" class="pro_img" alt=""/>
                                <?php } else {
                                    ?>
                            ...
                            <ul class="dropdown-menu act_sbmenu">
                                <li>
                                    <a href="<% url('/logout') %>">Logout<i class="fa fa-power-off"></i> </a>
                                </li>
                            </ul>
                        </li>
                    </ul>
