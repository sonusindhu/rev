    ...
    <div class="icons_dv">
        <ul >
            ...
            <li class="dropdown active admin_drpdown" >
                <a aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" class="dropdown-toggle" href="#"><span class="icon_spc left_imgs flt_lft">
                                                                                                             <img alt="" src="{!! asset('/images/admin_ico.png') !!}"/></span><span class="menu_name "> Admin</span><!--<span  id="admin_menu_icn"><img alt="" src="../images/trans_icons.png" class="dropdwn-icon"/></span>--></a>
