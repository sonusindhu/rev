        ...
        if (!empty($allEmployee)) {
            ...
            foreach ($allEmployee as $key => $value) {
                if ($i % 2 == 0) {
                    ...
                    <td><a style="cursor:pointer !important;" ng-click="deleteTabByName('Employemanagement');
                        page.addTab('<?php echo $value['EmployeeDetail']['emp_first_name'] . ' ' . $value['EmployeeDetail']['emp_last_name']; ?>', 'employee/add/<?php echo $value['EmployeeDetail']['id']; ?>', 'Employemanagement');
                    ...
                    <td class="cus_pro_td">
                        <a href="javascript:void(0);" ng-click="deleteTabByName('Employemanagement');
                            page.addTab('<?php echo $value['EmployeeDetail']['emp_first_name'] . ' ' . $value['EmployeeDetail']['emp_last_name']; ?>', 'employee/add/<?php echo $value['EmployeeDetail']['id']; ?>', 'Employemanagement');
                                activeStateCheck('Employemanagement');
                                editEmployeeRecord('<?php echo $value['EmployeeDetail']['id']; ?>');
