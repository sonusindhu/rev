<div class="modal-dialog" role="document">
    <form id="showLookupBranch" ng-submit="showLookup('employee/showLookupBranch', 'showLookupBranch', 'id')">
        <div class="modal-content">
                                    ...
                                    <tr> 
                                        <td colspan="2">
                                            <div class="checkbox"> <label> 
                                                    <input value="<?php echo $value['Branch']['id']; ?>" name="data[Branch][check]" type="checkbox" >
                                                </label> 
            ...
            <div class="modal-footer">
                <div class="col-md-12 text-center spc btm_btns">
                    ...
                    <button ng-click="showLookup('employee/showLookupBranch', 'showLookupBranch', 'id')" type="submit" class="btm_btns">Save</button><a href="javascript:void(0)" aria-label="Close" data-dismiss="modal" class=" cncel_btn">Cancel</a>
