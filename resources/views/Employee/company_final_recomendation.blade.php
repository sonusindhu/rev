<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Final Recommendation</h4>
        </div>
        <div class="modal-body clearfix">
            <h5>Hiring Committee Final Recommendation</h5>
        ...
        <div class="modal-footer">
            <div class="col-md-12 text-center spc btm_btns">
              <button ng-click="addDescription('committee_desc1')" class="btm_btns" type="button">Save</button>
