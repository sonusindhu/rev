...
myApp.controller('dataCtrl', ['$scope', '$http', '$sce', '$compile', '$modal',
    function ($scope, $http, $sce, $compile, $modal) {
        $scope.page = {
            data: {
...
//                         errorMesgs += '</div>';
        ...
        //getting and appending the list of users based on the selected filter
        //get the checked state on change of the region on the edit states popup
        ...
        //getting the list of users based on the selected filtered.
